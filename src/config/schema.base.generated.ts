...
export const GENERATED_BASE_CONFIG_SCHEMA = {
  ...
  uiHints: {
    ...
    "tools.media.audio.contextMode": {
      label: "Audio Context Mode",
      help: 'Controls how audio is injected into agent context. Use "transcript" to inline transcript only, or "transcript+summary" to prepend a compact summary for longer recordings.',
      tags: ["media", "tools"],
    },
    "tools.media.audio.summaryTriggerChars": {
      label: "Audio Summary Trigger Chars",
      help: "Character threshold after which OpenClaw generates an audio summary before injecting transcript into agent context. Raise this to avoid summarizing short voice notes.",
      tags: ["media", "tools"],
    },
    "tools.media.audio.inlineTranscriptMaxChars": {
      label: "Inline Audio Transcript Max Chars",
      help: "Maximum transcript characters kept inline in agent context before OpenClaw truncates the middle for long recordings. The full transcript is still preserved separately on the message context.",
      tags: ["performance", "media", "tools"],
    },
    "tools.media.audio.summaryMaxTokens": {
      label: "Audio Summary Max Tokens",
      help: "Maximum tokens allowed for audio summary generation when contextMode uses summaries. Keep this small to bound extra model cost on long voice notes.",
      tags: ["security", "auth", "performance", "media", "tools"],
    },
